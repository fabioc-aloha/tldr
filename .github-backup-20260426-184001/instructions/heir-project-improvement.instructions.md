...
Every trifecta component must share a common name prefix for Copilot semantic search:

| File Type | Naming Pattern | Example |
|-----------|---------------|---------|
| Skill | `.github/skills/{name}/SKILL.md` | `.github/skills/code-review/SKILL.md` |
| Instruction | `.github/instructions/{name}.instructions.md` | `.github/instructions/code-review.instructions.md` |
| Prompt | `.github/prompts/{name}.prompt.md` | `.github/prompts/code-review.prompt.md` |

Use identical base names (e.g., `code-review`) across all three files so Copilot's semantic search can correlate them.
...
- [ ] Architecture: All files have complete frontmatter (applyTo, description)
- [ ] Validation: brain-qa passes with 0 critical issues
```
...
3. For each candidate:
   ...
   e. Use consistent naming across all three
