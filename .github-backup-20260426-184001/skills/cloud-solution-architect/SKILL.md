...
## Cloud Design Patterns (44 Patterns)

WAF pillar mapping: **R**=Reliability, **S**=Security, **CO**=Cost Optimization, **OE**=Operational Excellence, **PE**=Performance Efficiency.
...
## Mission-Critical Design (99.99%+ SLO)
...
- **observability-monitoring** — Production visibility
...
- [Mission-Critical Workloads](https://learn.microsoft.com/en-us/azure/architecture/framework/mission-critical/)
